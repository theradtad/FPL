...
matches_json_path = '/home/amp/Desktop/big_data/BD_Project/matches_details.json'
input_player_data_path = '/home/amp/Desktop/big_data/BD_Project/inp_player.json'
output_player_data_path = '/home/amp/Desktop/big_data/BD_Project/out_player.json'
input_match_data_path = '/home/amp/Desktop/big_data/BD_Project/inp_match.json'
output_match_data_path = '/home/amp/Desktop/big_data/BD_Project/out_match.json'
input_prediction_data_path = '/home/amp/Desktop/big_data/BD_Project/inp_predict.json'
output_prediction_data_path = '/home/amp/Desktop/big_data/BD_Project/out_predict.json'
...
def regression_on_cluster(joined_records_ratings,cluster_number,player_birth_date,match_date):
	...
	joined_records_ratings = joined_records_ratings.filter((joined_records_ratings.number_of_matches < 5) & (joined_records_ratings.prediction == cluster_number)).select(["Id","name","rating","birthDate"])
	joined_records_ratings = joined_records_ratings.filter(joined_records_ratings.name.date != "0000-00-00")

	l1 = []
	for j in joined_records_ratings.rdd.collect():
		dateArraycur = j.name.date.split('-')
...
def regression_on_player(joined_records_ratings,player_id,birthDate,match_date):
	joined_records_ratings = joined_records_ratings.filter(joined_records_ratings.Id == player_id).select(["Id","name","rating","birthDate"])
	joined_records_ratings = joined_records_ratings.filter(joined_records_ratings.name.date != "0000-00-00")
...
def match_prediction(input_data):
	...
	joined_records_ratings = clustered_df.join(df_player_ratings,clustered_df.Id==df_player_ratings.name.player_id)
